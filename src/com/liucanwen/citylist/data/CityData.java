...
public class CityData
{
	...
	public static List<ContactItemInterface> getSampleContactList()
	{
		...
		try
		{
			...
			list.add(new CityItem("北京", "2"));
			list.add(new CityItem("上海", "2"));
			list.add(new CityItem("深圳", "2"));
			list.add(new CityItem("广州", "2"));
			list.add(new CityItem("南京", "2"));
			list.add(new CityItem("郑州", "2"));
